...
class MBPO(RLAlgorithm):
    ...
    def __init__(
        ...
        self.backoff_env = FakeEnv(self._model, self._static_fns)
            ...
            for i in count():
                ...
                if self._timestep % self._model_train_freq == 0 and self._real_ratio < 1.0:
                    ...
                    if hasattr(self, '_model_pool'):
                        model_train_metrics = self._union_train_model(batch_size=256, max_epochs=None, holdout_ratio=0.2, max_t=self._max_model_t)
    ...
    def _rollout_model(self, rollout_batch_size, **kwargs):
        ...
        print('[ Model Rollout ] End | Added: {:.1e} | Model pool: {:.1e} (max {:.1e}) | Length: {} | Train rep: {}'.format(
